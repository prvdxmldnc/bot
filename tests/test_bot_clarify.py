...
def test_clarify_choose_callback_supports_option_id(monkeypatch):
    captured = {"text": None}
...
def test_clarify_prev_callback_uses_offset_and_no_send(monkeypatch):
    captured = {"offset": None, "edited_text": None}
